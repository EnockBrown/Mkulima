 ...
 */
public class Goats extends Fragment {

    public static Goats INSTANCE=null;
    ...
    public Goats() {
        ...
        cattle=database.getReference("Diseases").orderByChild("type").equalTo("Goats");
    ...
    public static Goats getInstance(){
        if (INSTANCE==null)
            INSTANCE=new Goats();
        return INSTANCE;
    }
