 ...
 */
public class Livestock extends Fragment {

    public static Livestock INSTANCE=null;
    ...
    public Livestock() {
        ...
        crops=database.getReference("Products").orderByChild("product_type").equalTo("Livestock");
    ...
    public static Livestock getInstance(){
        if (INSTANCE==null)
            INSTANCE=new Livestock();
        return INSTANCE;
    }
